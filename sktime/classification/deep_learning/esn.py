...
class EchoStateNetwork(BaseClassifier):
    ...
    def _fit(self, X, y):
        ...
        # If base_classifier is not instantiated, instantiate it with the specified parameters
    ...
    def get_test_params(cls, parameter_set="default"):
      ...
      if parameter_set == "default-test":
          return params[0]
      elif parameter_set == "test1":
          return params[1]
      elif parameter_set == "test2":
          return params[2]
      else:
